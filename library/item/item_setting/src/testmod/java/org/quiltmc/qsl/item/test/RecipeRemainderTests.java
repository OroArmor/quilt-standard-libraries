...
public class RecipeRemainderTests implements ModInitializer {
	...
	public void onInitialize(ModContainer mod) {
		...
		Item cuttingInputRemainder = new Item(new QuiltItemSettings().recipeRemainder((original, recipe) -> Items.STONE.getDefaultStack(), RecipeRemainderLocation.STONE_CUTTER_INPUT));
