...
public final class ClientRegistrySync {
	...
	private static boolean isTextEmpty(Text text) {
		return (text.asComponent() == LiteralTextComponent.EMPTY || (text.asComponent() instanceof LiteralTextComponent literalComponent && literalComponent.asString().isEmpty())) && text.getSiblings().isEmpty();
	}
